...
## S-03 — تعريفات الأنظمة والتقارير
...
## S-06 — أرشفة التاريخ (Parquet + DuckDB)
...
## S-08 — مدير الوكلاء (وضع تحليل فقط)
