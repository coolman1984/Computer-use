...
| P2 — المحوّلات | مدقق ملفات، محوّل Playwright، عامل تشغيل وجدولة، أرشفة Parquet/DuckDB، تعريفات الأنظمة | Sonnet | حزم S-01..S-06 خضراء |
| P3 — الويب آب | لوحة، تشغيلات، أحداث، حوادث، بث حي | Sonnet (تصميم عام مني) | الشاشات تقرأ من API الحالي |
| P4 — مدير الوكلاء | تشغيل Codex/Claude، أوضاع تحليل/تجربة/تنفيذ، سجل كامل | العقد والسياسة: Opus — التنفيذ: Sonnet | تشغيل وكيل بوضع تحليل فقط ينتهي بسجل |
...
**النطاق التجريبي المستهدف:** 3 أنظمة، 5 تقارير، مشروع أتمتة واحد، إنذار تأخير واحد، حادثة واحدة كاملة، ووكيل في وضع تحليل فقط.
