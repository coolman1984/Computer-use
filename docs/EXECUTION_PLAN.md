...
**قرار تركيب متبقٍّ (ليس حزمة Sonnet جديدة):** كل محوّلات P2-P4 قائمة خلف عقودها بدون تفعيل تلقائي في `services.py`/`main.py` — بالتصميم. تفعيلها الفعلي في التشغيل الحقيقي (أي محوّل، بأي إعداد) قرار تشغيلي يحتاج مراجعة Opus، فصّلناه في `docs/AGENT_TASK_PACKETS.md`.
